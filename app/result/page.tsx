...
// Get the style data and handle sub-styles if needed
const rawStyleData = getStyleData(STYLE_KEY, STYLE_INDEX)
const styleData: StyleData = hasSubStyles(rawStyleData)
    ? getSubStyleData(STYLE_KEY, SUB_STYLE_INDEX, STYLE_INDEX)
    : (rawStyleData as StyleData)

export const metadata: Metadata = {
    title: styleData.metadata.title,
    description: styleData.metadata.description,
}
